...
$(document).ready(function(){ // begin document.ready block
 ...
 // TIMETABLE
    ...
    var margin = { top: 40, right: 0, bottom: 70, left: 30 },
          ...
          times = ["12 pm", "1 am", "2 am", "3 am", "4 am", "5 am", "6 am", "7 am", "8 am", "9 am", "10 am", "11 am", "12 am", "1 pm", "2 pm", "3 pm", "4 pm", "5 pm", "6 pm", "7 pm", "8 pm", "9 pm", "10 pm", "11 pm"];
    ...
    // STEFU
        ...
        var dayLabels = svg.selectAll(".axis-workweek")
        .data(days)
        .enter().append("rect")
        .attr("x", 0)
        .attr("y", function (d, i) { return i * gridSize; })
